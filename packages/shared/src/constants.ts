// Shared constants — used by both web and api
...
export type VoucherTypeCode = (typeof VOUCHER_TYPES)[keyof typeof VOUCHER_TYPES];
...
// Indian states with codes — used for GST
